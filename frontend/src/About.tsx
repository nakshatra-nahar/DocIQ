    ...
    <div className="mx-5 grid min-h-screen md:mx-36">
      <article className="place-items-left mx-auto my-auto flex w-full max-w-6xl flex-col gap-4 rounded-3xl bg-gray-100 p-6 text-jet dark:bg-gun-metal dark:text-bright-gray lg:p-6 xl:p-10">
        <div className="flex items-center">
          <p className="mr-2 text-3xl">About dociq</p>
          <img className="h14 mb-2" src={dociq3} alt="dociq" />
        </div>
        <p className="mt-4">
          Find the information in your documentation through AI-powered
          <a
            className="text-blue-500"
            href="https://github.com/arc53/dociq"
            target="_blank"
            rel="noreferrer"
          >
            {' '}
        ...
        <p>
          Currently It uses{' '}
          <span className="text-blue-950 font-medium">dociq</span>{' '}
          documentation, so it will respond to information relevant to{' '}
          <span className="text-blue-950 font-medium">dociq</span>. If you
          want to train it on different documentation - please follow
          <a
            className="text-blue-500"
            href="https://github.com/arc53/dociq/wiki/How-to-train-on-other-documentation"
            target="_blank"
            rel="noreferrer"
          >
            {' '}
        ...
        <p className="mt-4 text-left">
          ...
          <a
            className="text-blue-500"
            href="https://github.com/arc53/dociq/wiki/Hosting-the-app"
            target="_blank"
            rel="noreferrer"
          >
            {' '}
