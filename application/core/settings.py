...
class Settings(BaseSettings):
    ...
    MONGO_URI: str = "mongodb://localhost:27017/dociq"
    MODEL_PATH: str = os.path.join(current_dir, "models/dociq-7b-f16.gguf")
    ...
    ELASTIC_INDEX: Optional[str] = "dociq"  # index name for elasticsearch
    ...
    QDRANT_COLLECTION_NAME: Optional[str] = "dociq"
