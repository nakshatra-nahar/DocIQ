...
prompt_user() {
    echo "Do you want to:"
    echo "1. Use dociq public API (simple and free)"
...
download_locally() {
    ...
    # check if dociq-7b-f16.gguf does not exist
    if [ ! -f models/dociq-7b-f16.gguf ]; then
        echo "Downloading the model..."
        wget -P models https://d3dg1063dc54p9.cloudfront.net/models/dociq-7b-f16.gguf
