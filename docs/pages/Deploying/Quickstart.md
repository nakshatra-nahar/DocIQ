...
To enhance your dociq experience, you can install the dociq Chrome extension. Here's how:

1. In the dociq GitHub repository, click on the **Code** button and select **Download ZIP**.
...
7. Select the **Chrome** folder where the dociq files have been unzipped (dociq-main > extensions > chrome).
